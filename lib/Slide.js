...
function Slide(props) {
    ...
    var classes = props.classes,
        ...
        other = _objectWithoutProperties(props, ['classes', 'label', 'media', 'mediaBackgroundStyle', 'subtitle', 'title', 'mobile', 'landscape', 'onStart', 'ButtonProps']);
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'div',
            {
                className: (0, _classnames2.default)(classes.footer, (_classNames5 = {}, _defineProperty(_classNames5, classes.footerMobile, mobile), _defineProperty(_classNames5, classes.footerMobileLandscape, landscape), _classNames5))
            },
            label && _react2.default.createElement(
                _Button2.default,
                _extends({ variant: 'raised', onClick: onStart }, ButtonProps),
                label
            )
        )
    );
